...
| Setup Wizard | `App/SetupWizard/{SetupWizardView,SetupState}.swift`, `App/SetupWizard/Components/WizardChrome.swift`, `App/SetupWizard/Steps/*` | `SetupWizardView`, `SetupStep`, `SetupCompletion.markCompleted`, `SettingsRerunTrigger`, `closeAndComplete`, `WizardPanel` | §4.1–4.10, §13.2–13.3, §5.0, §6.1, §6.4, §7.1 |
| Settings | `App/Settings/*` (AI Rewrite cites `App/Settings/{AIRewriteSettingsView,EditPromptWithTestSheet}.swift`) | `SettingsView`, `SpeechModelVariantPicker`, `VocabularySettingsView`, `EmbeddingsPanelView`, `LLMClientUIAdapter` | §6.1–6.7, §7.5, §7.7–7.9, §7.12 |
...
| Supporting Surfaces | `App/Help/HelpView.swift`, `App/Feedback/*`, `App/Donation/*`, `App/Recents/*`, `App/Diagnostics/MemoryProbe.swift`, `Shared/DiagnosticsLog.swift` | `FeedbackClient.submit`, `DonationsService.fetchSummary`, `DiagnosticsLog.record`, `HelpView`, `RecentsListCard` | §6.5, §6.7, §9.1, §9.5–9.6, §1.2, §1.7–1.8, §13.6 |
